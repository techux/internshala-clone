...
// Dummy data to visualise the UI (replace with API fetch)
// const internships = [
//   {
...
//     logo: "https://internshala.com//static/images/interns/company_logo.svg",
//   },
//   {
//     title: "Founders Office",
//     company: "Krishna Translations",
//     location: "Chandigarh",
//     duration: "4 Months",
...
//     company: "Diasmos Private Limited",
//     location: "Ahmedabad",
//     duration: "6 Months",
  ...
  return [
    {
      internships_meta: {
        65381: {
          ...
          labels: [
            {
              label_value: ["International", "Internship"],
              label_mobile: ["International", "Internship"],
              label_app: ["International", "Internship"],
              labels_app_in_card: ["International", "Internship"],
            },
          ],
        ...
        65454: {
          ...
          labels: [
            {
              label_value: ["Internship"],
              label_mobile: ["Internship"],
              label_app: ["Internship"],
        ...
        65501: {
          ...
          segment_label_value: null,
          internship_type_label_value: null,
          job_segments: ["internship_for_women"],
        ...
        65522: {
          ...
          job_segments: [],
          company_name:
            "Alkymia Tech Private Limited Testing SMS For Optimization 12-a@",
          company_url:
            "/company/alkymia-tech-private-limited-testing-sms-for-optimization-12-a-1681983044",
          is_premium: true,
          is_premium_internship: true,
...
export default function App() {
  ...
  // Fetch internships data from API using useEffect
  useEffect(async () => {
  ...
  return (
    <div className="bg-[#f8f8f8] min-h-screen flex flex-col">
      ...
      <div className="w-[65%] mx-auto flex-1">
        ...
        <div className="mb-6 text-center pl-56">
